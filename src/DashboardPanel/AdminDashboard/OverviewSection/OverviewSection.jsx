    ...
    >
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-300">Summary of recent activities and key metrics</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {[
            ...
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover:border-[#B5000D]/50 transition-all"
            >
        ...
        >
          ...
          {loading ? (
            <div className="flex items-center justify-center p-12">
              ...
              <span className="ml-3 text-gray-300">Loading activities...</span>
            </div>
          ) : error ? (
            ...
            <div className="text-center p-12">
              ...
              <p className="text-gray-500 text-sm">Activity will appear here once available</p>
            </div>
          ) : (
            <div className="space-y-4">
              {currentActivities.map((activity, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  className="flex items-center justify-between p-4 bg-white/10 rounded-lg border border-white/5 hover:bg-white/20 transition-colors"
                >
                ...
                {selectedActivity.type === "user" && (
                  <>
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-white">{formatDate(selectedActivity.details.createdAt)}</p>
                    </div>
                  </>
                )}
