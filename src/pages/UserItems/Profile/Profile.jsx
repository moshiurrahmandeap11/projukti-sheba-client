...
import { User, Mail, Calendar, Clock, Settings, HelpCircle, LogOut, Star, CreditCard, Shield, Database, ArrowRight } from 'lucide-react';
                ...
                try {
                    ...
                    if (docSnap.exists()) {
                        ...
                        setUserData({
                            ...
                            lastLogin: new Date(user.metadata.lastSignInTime).toLocaleDateString(),
                            premium: false,
                            storageUsed: '0 MB',
                            projects: 0
                        });
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                <div className="mb-12">
                    <h2 className="text-xl font-bold text-white mb-6 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text">
                        {userData?.premium ? 'Your Premium Benefits' : 'Unlock Premium Features'}
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-xl hover:border-blue-500/30 transition-all duration-300">
                            ...
                            <h3 className="text-lg font-semibold text-white mb-2">Increased Storage</h3>
                            <p className="text-gray-400 mb-4">
                                {userData?.premium 
