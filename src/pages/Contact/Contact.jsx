...
import { Mail, Phone, MapPin, Clock, Send, User, MessageSquare, Building, Globe, Facebook, Twitter, Linkedin, Instagram, ArrowRight, CheckCircle } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-slate-900">
                ...
                {/* Geometric shapes */}
                <div className="absolute top-20 right-20 w-40 h-40 border border-white/5 rounded-full animate-spin" style={{ animationDuration: '25s' }}></div>
                <div className="absolute bottom-32 left-20 w-32 h-32 border border-purple-400/10 rounded-lg rotate-45 animate-pulse"></div>
                <div className="absolute top-1/2 right-10 w-20 h-20 bg-gradient-to-r from-blue-500/5 to-purple-500/5 rounded-full animate-bounce" style={{ animationDuration: '3s' }}></div>
            </div>
                ...
                <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto text-center">
                        ...
                        <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                            Ready to transform your digital presence? Let's discuss your project and bring your vision to life with cutting-edge IT solutions.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {contactInfo.map((item, index) => (
                                <div key={index} className="group bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 relative">
                                    ...
                                    <div className="relative z-10">
                                        <h3 className="text-2xl font-bold text-white mb-6">Projukti Sheba</h3>
                                        <p className="text-gray-300 mb-6 leading-relaxed">
                                            Leading IT solutions provider in Bangladesh, specializing in cutting-edge web development, mobile applications, and digital transformation services. We turn your ideas into reality with innovative technology solutions.
                                        </p>
                                ...
                                {/* Map Placeholder */}
                                <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 relative h-64">
                                    ...
                                    <div className="relative z-10 h-full flex items-center justify-center">
                                        <div className="text-center">
                                            ...
                                            <h4 className="text-xl font-semibold text-white mb-2">Find Us Here</h4>
                                            <p className="text-gray-400">Dhanmondi, Dhaka-1205, Bangladesh</p>
                                            <button className="mt-4 px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full text-sm font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-300">
                                                View on Map
                                            </button>
                                        </div>
                                    </div>
